...
namespace Tests.Controllers
{
    public class CategoriesControllerTests
    {
        ...
        public CategoriesControllerTests()
        {
            ...
            //var createCategory = new CreateCategoryUseCase(_mockCategoryRepository.Object, _mockFileStorage.Object); 
        ...
        {
            // Arrange
            //var category = new Category { Id = Guid.NewGuid(), Name = "New Category", Description = "Some description", ImageUri = "image.png" };
            //var categoryDto = new CreateCategoryRequest(category.Name, new FormFile());
